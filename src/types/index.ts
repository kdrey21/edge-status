...
export const LEAGUES: LeagueConfig[] = [
  ...
  },
  {
    ...
    // Off-season World Series futures matching (needed Nov–Mar). Kalshi uses
    // abbreviated names ("New York Y", "Chicago WS", "A's"); the sportsbook Odds
    // API spells them out — nickname keys ("yankees", "white sox") catch both.
    marketNameMap: {
      'arizona':             'ARI',
      'atlanta':             'ATL',
      'baltimore':           'BAL',
